...
class WalletMonitor:
    ...
    def remove_wallet(
        ...
        self.watched_wallets.discard(
            wallet_address
        )

        self.last_checked_blocks.pop(
            wallet_address,
            None,
        )
    ...
    def check_wallet(
        ...
        for transfer in transfers:
            ...
            # Ignore provider records that cannot
            # currently be normalized.
